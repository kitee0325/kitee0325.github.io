...
This article contains my notes from the paper "DMap: A Visualization Method for Time-Series Data". I'll discuss the problem statement, the evaluation criteria, the authors' approach, and the case study.
