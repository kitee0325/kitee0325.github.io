...
<img src={useBaseUrl('/stanford-cs448b/biological motion.gif')} />
{/* truncate */}

## Original

<object
  data={useBaseUrl('/stanford-cs448b/Lec12-animation.pdf')}
  type="application/pdf"
  width="100%"
  height="800px"
>
  <a href={useBaseUrl('/stanford-cs448b/Lec12-animation.pdf')}>Download PDF</a>.
</object>
...
<img src={useBaseUrl('/stanford-cs448b/U.S. gun deaths.gif')} />
...
- Volume rendering
  ...
  <img src={useBaseUrl('/stanford-cs448b/volume rendering.gif')} />

- Tracking multiple targets
  <img src={useBaseUrl('/stanford-cs448b/track dot.gif')} />
...
- Too many objects may move at once
  <img src={useBaseUrl('/stanford-cs448b/basic shape transition.gif')} />

#### [DimpVis](https://vialab.ca/research/dimpvis)

<object
  data={useBaseUrl(
    '/paper/DimpVis Exploring Time-varying Information Visualizations by Direct Manipulation.pdf'
  )}
  type="application/pdf"
  width="100%"
  height="800px"
...
<img src={useBaseUrl('/stanford-cs448b/michotte demonstration 1.gif')} />
![](https://kitee-1301346990.cos.ap-nanjing.myqcloud.com/Obsidian/202410081300348.png?imageSlim)

<hr />
How does it work?
<img src={useBaseUrl('/stanford-cs448b/Two Cylinder Stirling Engine.gif')} />
...
<object
  data={useBaseUrl(
    '/paper/Animated Transitions in Statistical Data Graphics.pdf'
  )}
  type="application/pdf"
  width="100%"
  height="800px"
