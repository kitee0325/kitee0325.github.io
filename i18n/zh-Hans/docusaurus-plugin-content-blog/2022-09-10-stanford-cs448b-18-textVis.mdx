...
<object
  data={useBaseUrl('/stanford-cs448b/Lec18-textVis.pdf')}
  type="application/pdf"
  width="100%"
  height="800px"
>
  <a href={useBaseUrl('/stanford-cs448b/Lec18-textVis.pdf')}>下载 PDF</a>.
</object>
...
<a
  href={useBaseUrl(
    '/stanford-cs448b/Review Spotlight A User Interface for Summarizing User-generated Reviews Using Adjective-Noun Word Pairs.pdf'
  )}
>
